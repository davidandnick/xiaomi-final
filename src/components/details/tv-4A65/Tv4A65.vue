...
export default {
  ...
  data: function() {
    return {
      ...
      commentNumber: 1, // 评论滑块的数量
      // 产品信息
      product: {
        name: '小米电视4A 65英寸',
        information: '4K超高清屏 / 四核64位高性能处理器，支持HDR10 / 2GB+8GB大存储 / 人工智能语音 / 支持壁挂',
        extraInformation: '「“十一欢购黄金周”10月1日-10月8日限时特惠！活动期间每天前500名支付电视赠HDMI高清线1折礼券！」',
        price: '￥2699',
        oldPrice: '￥2999',
        choose: '小米电视4A 65英寸 黑色 x 1',
        configurations: [
          {
            id: 0,
            image: img1,
